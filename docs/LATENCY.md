...
`pump-quant-app` golden-digest test (`GOLDEN_DIGEST = 617_234_374_244_928_651`,
`net = 8_124_568`) was re-run after each edit and never moved, and the full workspace +
