...
from build_management_c10 import load_tape, TRADES, parse_c8  # noqa: E402
...
DIR = "/training/v2/reports/mgmt_c10"
...
def main():
    ...
    cfg = RewardConfig(lambda_exposure=0.08884, horizon_ms=300_000)
    agree = 0
    disagree = []
    for r in sample:
        m = r["meta"]
        ...
        dec = score_decision(t, m["decision_time_unix_ms"], family="management", cfg=cfg,
                             entry=entry, horizon_ms=300_000)
