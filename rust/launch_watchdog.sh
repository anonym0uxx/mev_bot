...
echo "    --strategy-label rev13-entry-quality-v1"
echo ""
...
exec ./target/release/pq-watchdog \
    ...
    --backoff-cap-secs 30 \
    --daemon-args "--junction-cap 8192 --commitment processed --status-every-ticks 50 --brain-snapshot-every-ticks 5000 --tape-every-ticks 200 --refiner-every-ticks 72000 --strategy-label rev13-entry-quality-v1"
