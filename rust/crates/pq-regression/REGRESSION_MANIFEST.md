...
golden digest `13693021370354439552` (net `31111528`), **191** dossiers intact.
...
|---|---|---|
| `GOLDEN_DIGEST` | `13693021370354439552` (hex `be07626339cf1580`) | byte-exact decision-journal digest of the golden tape under `Config::dev_portable` — the primary determinism fingerprint (§22/§54) |
| `GOLDEN_NET_LAMPORTS` | `31111528` | realized §24-compliant cost-derived net-SOL on the golden tape |
...
| `GOLDEN_NET_FIXED_LADDER` | `31302978` | net with the §24 cost-derived ladder DISABLED (forbidden fixed 13500/25000/50000 ladder). Re-measured at re-pin #26 under the unified cost model (was `7327315` at re-pin #24, `15055700` on the fictional tape) |
...
`2979624 → 5017234 → 6443936 → 8785954 → 12550767 → 3831945 → 1406102 → 1864780 → 8124568 → 16778896 → 31111528`.
...
- **derived_targets_reversal_moves_the_golden_net_off_the_fixed_ladder** — §24
  default-ON produces the derived net (`31111528`); OFF falls back to the forbidden
