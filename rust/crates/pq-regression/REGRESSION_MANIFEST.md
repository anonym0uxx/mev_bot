...
golden digest `8413891310981713968` (net `15410801`), **191** dossiers intact.
...
|---|---|---|
| `GOLDEN_DIGEST` | `8413891310981713968` (hex `32075ed6b12469ff`) | byte-exact decision-journal digest of the golden tape under `Config::dev_portable` — the primary determinism fingerprint (§22/§54) |
