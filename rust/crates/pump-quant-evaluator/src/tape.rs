        ...
        match kind {
            ...
            "trade_full" => {
                tape.full_trades.push(TradeFull {
                    ...
                    size_lamports: as_u64(
                        get_int(&obj, "size_lamports", lineno)?,
                        "size_lamports",
                        lineno,
                    )?,
                    strategy_id: as_u64(
                        get_int(&obj, "strategy_id", lineno)?,
                        "strategy_id",
                        lineno,
                    )?,
                    source: get_str_owned(&obj, "source", lineno)?,
                    outcome: get_str_owned(&obj, "outcome", lineno)?,
                    realized_pnl_lamports: as_i64(
                        get_int(&obj, "realized_pnl", lineno)?,
                        "realized_pnl",
                        lineno,
                    )?,
                    fees_lamports: as_u64(get_int(&obj, "fees", lineno)?, "fees", lineno)?,
                    slippage_lamports: as_u64(
                        get_int(&obj, "slippage", lineno)?,
                        "slippage",
                        lineno,
                    )?,
                    decision_latency_us: as_u64(
                        get_int(&obj, "decision_latency_us", lineno)?,
                        "decision_latency_us",
                        lineno,
                    )?,
                    confirm_latency_us: as_u64(
                        get_int(&obj, "confirm_latency_us", lineno)?,
                        "confirm_latency_us",
                        lineno,
                    )?,
